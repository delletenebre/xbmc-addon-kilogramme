...
import xbmcplugin
from _header import *
import site_tskg, site_ockg, site_onair, site_ontvkg, site_nbmv, site_nbts, site_ontv, site_wcam
...
def index():
    items = [
        ...
        {'label': site_ontv.BASE_NAME, 'icon' : get_local_icon(site_ontv.BASE_LABEL), 'path': plugin.url_for(site_ontv.BASE_LABEL + '_index'), 'is_not_folder':True},
